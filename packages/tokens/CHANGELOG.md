...
- ef1b44e: Add a semantic type scale, and fix two defects surfaced by building the first
...
- 299bd35: Primitive value change to test release automation

## 0.1.0

### Minor Changes

- c3cc618: Updating a gray primitive to check automation pipeline
